...
students.filter(s => s.Age <= 18);
  ...
  if (loading) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <img
          src="https://tse2.mm.bing.net/th/id/OIP.qFQCGd6aKnM83b19GI5ShgHaHa?cb=ucfimg2&ucfimg=1&rs=1&pid=ImgDetMain&o=7&rm=3"
          alt="loading"
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between px-4">
        ...
        <button  onClick={() => { resetForm(); setOpenModal(true); }} className="bg-pink-500 text-white text-lg w-full sm:max-w-[180px] h-[45px] px-3 rounded-xl font-bold">
          + Add Students
      </button>
  ...
  <button
    onClick={() => edit(el.id)}
    className="text-green-600 border border-green-500 cursor-pointer rounded-md px-3"
  >
    Edit
  </button>
  <button
